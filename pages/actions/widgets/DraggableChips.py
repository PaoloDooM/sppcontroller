            ...
            content=ft.Row(
                [
                    ft.IconButton(icon=ft.icons.EDIT, on_click=edit,
                                  icon_size=contentSize, height=contentSize, visible=True if event.index >= 0 else False),
                    ft.Text(value=f'{event.eventType.getLabel()}', size=contentSize,
                            overflow=ft.TextOverflow.FADE, weight=ft.FontWeight.BOLD),
